...
class DynamicToolStorage:
    ...
    def _create_pagination(
        self, total_count: int, limit: int, offset: int, tools_count: int = 0
    ) -> PaginationSchema:
        ...
        return PaginationSchema(
            ...
            limit=limit,
            offset=offset,
            has_more=offset + tools_count < total_count,
        )
    ...
    async def list_all_tools(
        ...
        async with self.typed_pool.acquire() as conn:
            ...
            pagination = self._create_pagination(total_count, limit, offset, len(tools))
    ...
    async def delete_tool(self, tool_id: uuid.UUID, user_id: str) -> bool:
        ...
        async with self.typed_pool.acquire() as conn:
            ...
            # asyncpg execute returns "DELETE N" where N is the row count
