...
from models.openai.chunking_strategy_response import ChunkingStrategyResponse
from models.openai.other_chunking_strategy_response_param import (
    OtherChunkingStrategyResponseParam,
)
from models.openai.static_chunking_strategy import StaticChunkingStrategy
from models.openai.static_chunking_strategy_response_param import (
...
class VectorStoreFileObject(BaseModel):
    ...
    chunking_strategy: Annotated[
        Optional[ChunkingStrategyResponse], Field(default=None)
    ] = None
