...
class ComposerClient:
    ...
    def stub(self):
        ...
        if self._stub is None:
            from server_composer.v1 import server_composer_pb2_grpc
...
class RunnerClient:
    ...
    async def execute_pipeline(
        ...
        **kwargs,
        ...
        create_response = await self.stub.CreatePipeline(create_request, timeout=timeout)
    ...
    async def evict_pipeline(self, pipeline_id: str, force: bool = False, timeout: float = 30.0):
